    ...
    return (
        <div>
            ...
            <EntryParagraph>
                ...
                The typical height of a fully grown Gluttonite ranges from 2 meters to 3.5 meters, with resting weights generally within the range of 150 kg to 300 kg. Given their substantial protein intake, Gluttonites
            ...
            <EntryParagraph>
                Gluttonites with larger bellies typically have an enlarged stomach containing some amount of acid at all times. The digestion process for an entire average-sized individual can take anywhere from a few minutes
            ...
            <EntryParagraph>
                ...
                <Eul>
                    <li>being male with a substantial size (above 150 kg in weight and 2 m tall);</li>
                ...
                Gluttonites also have a particular demeanor, often learned through life experiences, with attributes such as:
                <Eul>
                ...
                reduces humans to mere meals, which is why it is crucial to maintain precautions when interacting with Gluttonites. If you believe you have encountered a Gluttonite, consider the following safety procedures:
