...
const Kamu = () => {
    return (
        <div>
            ...
            <EntryParagraph>
                Kamu's origins remain unknown, with little to no information being known about him. His ties to the island of <EA href="https://en.wikipedia.org/wiki/Niue">Niue</EA> suggest that he was born and raised there,
            ...
            <EntryParagraph>
                ...
                to shape-shift and his insatiable hunger. He is a complex deity associated with fertility, agriculture, and, importantly, the protection of nature. In addition to his, he is also described as a glutton and a loner, much like Kamu.
            </EntryParagraph>
            <EHr />
