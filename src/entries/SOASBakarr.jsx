    ...
    return (
        <div>
            ...
            <EntryIntroduction imgSrc="SOASBakarr.png" imgDesc="A depiction of Bakarr." infoTableData={infoData}>
                <b>Special Operations Advance Scout Bakarr</b>, also known as Fenris Bakarr, is a highly classified operative and a key asset for a private military company (PMC), <EA href="#/entries/Aegis_Military_and_Security">Aegis Military and Security</EA>. Designed for deployment in
                ...
                down and absorbing enemies are unparalleled, making him the fastest and most efficient of all known Gluttonites. Due to the sensitive nature of his missions, details about his existence and operations remain shrouded in secrecy,
            ...
            <EntryParagraph>
                ...
                Bakarr voluntarily stays in his chamber, and if he chooses to venture outside, a full security detail must be conducted. However, access to his quarters is restricted to his team and superiors. Other than communicating with his team in communal areas, Bakarr spends most of
